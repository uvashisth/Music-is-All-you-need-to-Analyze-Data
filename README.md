...
![Overall Architecture Flow](https://github.com/uvashisth/UAlberta-Multimedia-Masters-Program-Music-is-all-you-need-to-analyze-data/blob/master/Assets/flow_architecture.PNG)

#### Data Influencing Technique
![Data Influencing Technique](https://github.com/uvashisth/UAlberta-Multimedia-Masters-Program-Music-is-all-you-need-to-analyze-data/blob/master/Assets/Data_influencing_technique.png)
...
![LSTM Model](https://github.com/uvashisth/UAlberta-Multimedia-Masters-Program-Music-is-all-you-need-to-analyze-data/blob/master/Assets/lstm%20model.png)
...
<p align="center">
  <img src="https://github.com/uvashisth/UAlberta-Multimedia-Masters-Program-Music-is-all-you-need-to-analyze-data/blob/master/Assets/Input_Structure.png">
...
We normalize the data and scale it down to a range of 0 to 1 and feed it as an input to our existing set of validation set.
The LSTM Model is shown below:
![LSTM Model](https://github.com/uvashisth/UAlberta-Multimedia-Masters-Program-Music-is-all-you-need-to-analyze-data/blob/master/Assets/lstm_model2.png)
